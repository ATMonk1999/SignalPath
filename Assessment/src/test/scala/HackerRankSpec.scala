...
class HackerRankSpec extends AnyFreeSpec {
  "MinimumBribes" - {
    "should produce exception" in {
      assertThrows[Exception] {
        MinimumBribes.minimumBribes(Array(2, 5, 1, 3, 4))
      }

      assertThrows[Exception] {
        MinimumBribes.minimumBribes(Array(5, 1, 2, 3, 7, 8, 6, 4))
      }
    }
    ...
    "should return 3" in {
      ...
      assert(MinimumBribes.minimumBribes(test) == 3)
    }
    ...
    "should return 7" in {
      ...
      assert(MinimumBribes.minimumBribes(test) == 7)
    }
    ...
    "should return 4" in {
      ...
      assert(MinimumBribes.minimumBribes(test) == 4)
    }
    ...
    "should return 966" in {
      ...
      assert(MinimumBribes.minimumBribes(test) == 966)
    }
  }
  ...
  "MinimumSwaps" - {
    "testcase #0" in {
      ...
      assert(MinimumSwaps.minimumSwaps(test) == 5)
    }
    ...
    "testcase #1" in {
      ...
      assert(MinimumSwaps.minimumSwaps(test) == 3)
    }
    ...
    "testcase #4" in {
      ...
      assert(MinimumSwaps.minimumSwaps(test) == 9)
    }
  }
}
